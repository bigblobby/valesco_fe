...
export const ButtonStyles = cn(
    'relative inline-flex justify-center font-medium text-white text-center text-sm bg-orange-400 border-2 border-orange-400 rounded-sm px-5 py-2.5 transition-colors',
    'hover:bg-orange-500',
